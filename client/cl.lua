...
local config = {
	...
	VehicleParkedMultiplier = 0.0,
	VehicleAmountParkedMultiplier = 0.0,
...
CreateThread(function()
	while true do
		...
		SetVehicleDensityMultiplierThisFrame(config.VehicleTrafficMultiplier)
		SetRandomVehicleDensityMultiplierThisFrame(config.VehicleTrafficMultiplier)

		SetParkedVehicleDensityMultiplierThisFrame(config.VehicleParkedMultiplier)
		SetNumberOfParkedVehicles(config.VehicleAmountParkedMultiplier)
		...
		SetCreateRandomCopsNotOnScenarios(config.RandomCopsNotOnScenarios)
		SetCreateRandomCopsOnScenarios(config.RandomCopsOnScenarios)
